...
SCRUM is the framework built to put the following values into practice:
Agile Manifesto – values:  
•	People overuse processes
•	Products that actually work versus over documenting what a product is supposed to do
•	Collaborating with customers instead of negotiating with them
•	Responding to change and not just following the plan
...
Building a culture of commitment and trust is key when a great idea comes along.
“The biggest mistake is when there is never an opportunity for an employee to make a mistake.” 
